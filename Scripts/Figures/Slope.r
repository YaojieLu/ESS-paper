...
plot(datab$P50, datab$sigma,
     ...
     xlim=c(-10, 0), ylim=c(0, 1.5), cex.lab=1.3, pch=1, lwd=1)
...
text(-10*0.965, 1.5*1.04*0.95, "c", cex=1.3)
legend("topright", legend=expression(Martinez-vilalta~italic(et~al.)~2014), lty=1, lwd=1, pch=1)
box()
