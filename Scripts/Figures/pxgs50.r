...
curve(0.49*x-0.42, -7, -1, lty=1, add=T, lwd=1, col="red")

points(subset(dataDVSIII, d<11, select=c("P50", "pxgs50")), type="l", lwd=1)
points(subset(dataDVSI, h3==1 & d<11, select=c("P50", "pxgs50")), type="l", lwd=4)
points(subset(dataDVSI, h3==100 & d<11, select=c("P50", "pxgs50")), type="l", lty=2, lwd=4)
...
text(-10*0.965, -10*0.05, "d", cex=1.3)
legend("bottomright", c("Klein 2014"), lty=1, lwd=1, col="red")
box()
